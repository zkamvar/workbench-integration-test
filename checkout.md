...
- any [Data Carpentry]({{ site.dc\_site }}/lessons/), [Library Carpentry]({{ site.lc\_site }}/lessons/), or [Software Carpentry]({{ site.swc\_site }}/lessons/) lesson
...
Carpentries lesson programs. Please refer to the lists of [Data Carpentry lessons]({{ site.dc\_site }}/lessons/), [Library Carpentry lessons]({{ site.lc\_site }}/lessons/), and [Software Carpentry lessons]({{ site.swc\_site }}/lessons/) on the websites.
